...
@Slf4j
@RestController
@RequestMapping("/api/textconsts")
public class TextConstController {
     ...
     */
    @GetMapping(path = "/{id}")
    public TextConst getTest(@PathVariable("id") final Long id) {
        return textConstService.get(id);
    }
    ...
    public TextConst save(final TextConst textConst) {
        return textConstService.save(textConst);
    }
